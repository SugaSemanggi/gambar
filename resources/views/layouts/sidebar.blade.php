              ...
              <li class="nav-item nav-dropdown">
                ...
                <i class="nav-icon icon-puzzle"></i> Base</a>
                    <ul class="nav-dropdown-items">
                        <li class="nav-item">
                            <a class="nav-link" href="{{Route('root-category.index')}}">
                                <i class="nav-icon icon-drop"></i> Root Category </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{Route('sub-category.index')}}">
                                <i class="nav-icon icon-puzzle"></i> Sub Category</a>
                        </li>
                    </ul>
                </li>
...
<div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 562px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 265px;"></div></div></nav>
